...
const Facture = () => {
  ...
  const { seller, buyer, dataTransaction } = useContext(AppContext)
    ...
    >
      <div className='header'>
        <p>
          ...
          <span style={{ fontFamily: 'monospace', fontSize: '1.1rem' }}>
            {dateFormat(dataTransaction.wystaw)}
          </span>
        </p>
        <p>
          Data sprzedaży{' '}
          <span style={{ fontFamily: 'monospace', fontSize: '1.1rem' }}>
            {dateFormat(dataTransaction.sprzed)}
          </span>
        </p>
      </div>
      <div className='nr'>
        <h1>
          Faktura nr: <span>{dataTransaction.nr}</span>
        </h1>
      </div>
      <div className='facture-wrapper'>
        <div className='sprzedawca'>
          ...
          <div className='city'>
            <span>{seller.kod}</span>
          </div>
          <div className='nip'>
            NIP: <span>{formattedNipNumber(newNip)}</span>
          </div>
          <div className='email'>
            e-mail: <span>{seller.email}</span>
          </div>
          <div className='cont'>
            Nr konta: <span>{formattedKontoNumber}</span>
          </div>
        </div>
        <div className='nabywca'>
          ...
          <div className='nip'>
            NIP: <span>{formattedNipNumber(newNipBuyer)}</span>
          </div>
          <div className='email'>
            e-mail: <span>{buyer.email}</span>
          </div>
        </div>
      </div>
      <Table />
      <div className='signature'>
        <div className='exhibitor'>
          ------------------------------- <br /> osoba upoważniona do
          wystawienia{' '}
        </div>
        <div className='recipient'>
          ------------------------------- <br /> osoba upoważniona do odbioru{' '}
        </div>
      </div>
      <div className='print'>
